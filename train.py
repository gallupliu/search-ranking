...
#             'all_topic_fav_7', 'all_topic_fav_14', 'topic_id', 'post_type', 'keyword', 'click_seq', 'label']
recall_data = {
    ...
    "most_reply_topic_name": [["奶", "牛"], ["粉"], ["牛"], ["中", "国"], ["奶"], ["奶", "牛"], ["粉"], ["牛"], ["中", "国"], ["奶"]],
    "most_post_topic_name": [["奶", "牛"], ["粉"], ["牛"], ["中", "国"], ["奶"], ["奶", "牛"], ["粉"], ["牛"], ["中", "国"], ["奶"]],
    "fellow_topic_id": ["177",
...
for seqs in recall_data['click_seq']:
    ...
    ids.append(id)
print(ids)
filename = 'models/item_embed.json'

# 训练skip-gram 模型
model = Word2Vec(ids, vector_size=32, window=10, min_count=1, iter=10, workers=multiprocessing.cpu_count())
# model = Word2Vec(LineSentence(recall_data['click_seq']), size=32, window=3, min_count=1, workers=multiprocessing.cpu_count())
# model.save(outp1)
save_path = 'models/item_model.vector'
